...
/*   Updated: 2024/06/02 22:36:45 by deydoux          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	return (init_sem(SEM_NAME_DONE, 0, &philo->done_sem)
		|| init_sem(SEM_NAME_EXIT, 0, &philo->exit_sem)
		|| init_sem(SEM_NAME_EXIT_CHANGE, 1, &philo->exit_change_sem)
